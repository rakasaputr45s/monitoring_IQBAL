...
# 2 "D:\\Monitoring Iqbal\\PZEM_017\\PZEM_017.ino" 2
static uint8_t pzemSlaveAddr = 0x02; //PZem Address
static uint8_t pzemSlaveAddr2 = 0x02; //PZem Address
...
void setShunt(uint8_t slaveAddr) {
  ...
  Serial2.write(((uint8_t) ((registerAddress) >> 8)));
  Serial2.write(((uint8_t) ((registerAddress) & 0xff)));
  Serial2.write(((uint8_t) ((NewshuntAddr) >> 8)));
  Serial2.write(((uint8_t) ((NewshuntAddr) & 0xff)));
  Serial2.write(((uint8_t) ((u16CRC) & 0xff)));
  Serial2.write(((uint8_t) ((u16CRC) >> 8)));
  delay(10); delay(100);
  while (Serial2.available()) {
    Serial.print(char(Serial2.read()), 16); //Prints the response and display on Serial Monitor (Serial)
    Serial.print(" ");
  }
}
//setShunt Ends
