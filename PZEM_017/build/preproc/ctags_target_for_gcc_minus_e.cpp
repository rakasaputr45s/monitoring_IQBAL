# 1 "D:\\Monitoring Iqbal\\PZEM_017\\PZEM_017.ino"
...
# 20 "D:\\Monitoring Iqbal\\PZEM_017\\PZEM_017.ino" 2
...
# 40 "D:\\Monitoring Iqbal\\PZEM_017\\PZEM_017.ino" 2
...
void preTransmission() /* transmission program when triggered*/
{
        ...
        digitalWrite(3 /* Define RE Pin to Arduino pin. Connect RE Pin of Max485 converter module to Pin 3 (default) Arduino board*/, 1); /* put RE Pin to high*/
        digitalWrite(1 /* Define DE Pin to Arduino pin. Connect DE Pin of Max485 converter module to Pin 2 (default) Arduino board*/, 1); /* put DE Pin to high*/
...
void postTransmission() /* Reception program when triggered*/
{
        ...
        digitalWrite(3 /* Define RE Pin to Arduino pin. Connect RE Pin of Max485 converter module to Pin 3 (default) Arduino board*/, 0); /* put RE Pin to low*/
        digitalWrite(1 /* Define DE Pin to Arduino pin. Connect DE Pin of Max485 converter module to Pin 2 (default) Arduino board*/, 0); /* put DE Pin to low*/
}
...
void setShunt(uint8_t slaveAddr) //Change the slave address of a node
{
        ...
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((registerAddress) >> 8)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((registerAddress) & 0xff)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((NewshuntAddr) >> 8)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((NewshuntAddr) & 0xff)));

        preTransmission(); /* trigger transmission mode*/

        Serial.write(slaveAddr); /* these whole process code sequence refer to manual*/
        Serial.write(SlaveParameter);
        Serial.write(((uint8_t) ((registerAddress) >> 8)));
        Serial.write(((uint8_t) ((registerAddress) & 0xff)));
        Serial.write(((uint8_t) ((NewshuntAddr) >> 8)));
        Serial.write(((uint8_t) ((NewshuntAddr) & 0xff)));
        Serial.write(((uint8_t) ((u16CRC) & 0xff)));
        Serial.write(((uint8_t) ((u16CRC) >> 8)));
        delay(10);
        postTransmission(); /* trigger reception mode*/
        delay(100);
...
void changeAddress(uint8_t OldslaveAddr, uint8_t NewslaveAddr) //Change the slave address of a node
{
        ...
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((registerAddress) >> 8)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((registerAddress) & 0xff)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((NewslaveAddr) >> 8)));
        u16CRC = crc16_update(u16CRC, ((uint8_t) ((NewslaveAddr) & 0xff)));
        ...
        Serial.write(((uint8_t) ((registerAddress) >> 8)));
        Serial.write(((uint8_t) ((registerAddress) & 0xff)));
        Serial.write(((uint8_t) ((NewslaveAddr) >> 8)));
        Serial.write(((uint8_t) ((NewslaveAddr) & 0xff)));
        Serial.write(((uint8_t) ((u16CRC) & 0xff)));
        Serial.write(((uint8_t) ((u16CRC) >> 8)));
        delay(10);
        postTransmission(); /* trigger reception mode*/
